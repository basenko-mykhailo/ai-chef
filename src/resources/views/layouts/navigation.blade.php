        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-gray-800 hover:text-gray-900">
                        <svg class="h-7 w-7 text-indigo-600" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                        ...
                        <span class="font-semibold text-lg tracking-tight">AI Chef</span>
                    </a>
                </div>
